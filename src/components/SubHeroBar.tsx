...
export default function SubHeroBar() {
  ...
  return (
    <div className="w-full bg-[#FAF9F6] z-20 relative font-sans">
          ...
          <div className="lg:col-span-8 flex flex-col sm:flex-row items-stretch gap-4">
            ...
            <div className="flex-1 bg-[#D2007A] text-white py-4.5 px-6 md:px-8 rounded-3xl shadow-md flex items-center justify-between gap-6">
              ...
              <div className="flex flex-col text-left">
                <span className="text-[12px] tracking-[2px] uppercase font-bold text-pink-100">
                  Residencial
                </span>
                <h2 className="text-[25px] font-black tracking-tight uppercase leading-none mt-1 font-sans">
                  Las Bugambilias
                </h2>
              </div>
              ...
              <div className="flex flex-col text-right shrink-0">
                ...
                <span className="text-[32px] font-black text-[#FFD100] mt-1 tracking-tight leading-none font-sans">
                  S/199
                </span>
              </div>
            ...
            <div className="w-full sm:w-[240px] flex flex-col justify-center gap-3.5 bg-[#ffffff] p-5 rounded-3xl border border-neutral-300 shadow-sm shrink-0">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col text-left">
                  <p className="font-sans font-black text-[12px] text-[#D2007A] leading-none uppercase">
                    1ra ETAPA
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                <div className="w-5 h-5 rounded-full border border-neutral-300 flex items-center justify-center shrink-0 bg-white">
                  <MapPin className="w-3 h-3 text-neutral-300 stroke-[3px]" />
                </div>
                <div className="flex flex-col text-left">
                  <p className="font-sans font-black text-[12px] text-neutral-700 leading-none uppercase">
                    La Joya / Arequipa
                  </p>
                </div>
              </div>
